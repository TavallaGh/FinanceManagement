/* Filename: financial/TransactionReviewGrid.js */
(() => {
  ...
  const TransactionReviewGrid = React.forwardRef(({ itemsData = [], onItemsChange, lookups, isReadOnly, formCode, language = 'fa', showToast }, ref) => {
  ...
  window.TransactionReviewGrid = TransactionReviewGrid;
})();