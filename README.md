...
```
cd existing_repo
git remote add origin https://gitlab.com/next-top-tech/accounting/accounting-workspace.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/next-top-tech/accounting/accounting-workspace/-/settings/integrations)
